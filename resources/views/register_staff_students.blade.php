...
<head>
    ...
    <title>Register Staff Students - Glorious Academy</title>
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu open" id="sub-accounts">
                        ...
                        <li><a href="/register-staff-students" class="active">Register Staff Students</a></li>
