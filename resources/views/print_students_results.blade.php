...
<head>
    ...
    <title>Print Students Results - Glorious Academy</title>
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu open" id="sub-accounts">
                        ...
                        <li><a href="/register-staff-students" class="active">Print Students Results</a></li>
