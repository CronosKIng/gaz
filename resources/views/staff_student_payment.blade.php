...
<head>
    ...
    <title>Staff Student Payment - Glorious Academy</title>
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu open" id="sub-accounts">
                        ...
                        <li><a href="/register-staff-students" class="active">Staff Student Payment</a></li>
